...
- [#9759](https://github.com/better-auth/better-auth/pull/9759) [`f6bf451`](https://github.com/better-auth/better-auth/commit/f6bf45123fdd3b045a7cadff779fb41acd17d08c) Thanks [@ping-maxwell](https://github.com/ping-maxwell)! - fix(api-key): add better-call as peer dependency to fix TS4023 declaration emit
